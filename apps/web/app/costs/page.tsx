...
import { App, Button, Empty, Form, InputNumber, Modal, Select, Space, Spin, Table } from "antd";
...
function CostsContent() {
  ...
  const fetchCosts = async () => {
    try {
      setLoading(true);
      const response = await apiClient.getCosts(pagination.page, pagination.limit, undefined, showActive);
