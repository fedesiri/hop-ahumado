...
const navRows: NavRow[] = [
  ...
  { type: "item", path: "/stock/suggested-order", label: "Pedido sugerido", icon: <ClipboardList size={18} />, sub: true, businessLine: BusinessLine.BEER },
  ...
  { type: "item", path: "/operational-parameters", label: "Canales y Catering", icon: <Percent size={18} />, businessLine: BusinessLine.BEER },
  { type: "divider", key: "d4" },
